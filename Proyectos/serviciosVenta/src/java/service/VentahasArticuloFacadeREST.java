...
public class VentahasArticuloFacadeREST extends AbstractFacade<VentahasArticulo> {
    ...
    @PersistenceContext(unitName = "serviciosVentaPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, VentahasArticulo entity) {
        super.edit(entity);
    }
    ...
    public VentahasArticulo find(@PathParam("id") Integer id) {
